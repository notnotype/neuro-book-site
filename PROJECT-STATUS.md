...
| 官方站 OAuth provider 与 llmlint SSO（Task 133） | In Progress | provider 端点、OAuthClient/authorization code/access token migration、固定 `llmlint-web` client 初始化工具和 llmlint S256 PKCE 回调已在工作树完成；待双仓 PR 合并、DMIT 正式服务安装和公网闭环。 |
